      ...
      <div class="row">
        ...
        <div class="col-md-4 pt-5">
          ...
          <ul class="list-unstyled text-light footer-link-list">
            <li>
              ...
              Urbanizacion Santa Mercedes Mz.B Lt.03 - El Agustino
            </li>
            <li>
              <i class="fa fa-phone fa-fw"></i>
              <a class="text-decoration-none" href="tel:010-020-0340">+51-959127487</a>
            </li>
            <li>
              <i class="fa fa-envelope fa-fw"></i>
              <a class="text-decoration-none" href="mailto:info@company.com">magalychurata@gmail.com</a>
            </li>
          </ul>
        </div>
        ...
        <div class="col-md-4 pt-5">
          ...
          <ul class="list-unstyled text-light footer-link-list">
            ...
            <li><a class="text-decoration-none" href="#">Calzado para Damas</a></li>
            <li><a class="text-decoration-none" href="#">Vestidos de verano</a></li>
            <li><a class="text-decoration-none" href="#">Accesorios de ropa</a></li>
